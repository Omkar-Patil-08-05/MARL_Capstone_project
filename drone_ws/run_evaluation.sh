...
echo "[Evaluation] Starting Gazebo..."
...
echo "[Evaluation] Wait 5 seconds for static drone initialization..."
sleep 5

echo "[Evaluation] Starting Bridge..."
...
echo "[Evaluation] Running Evaluator Node..."
python3 -u /home/capstone/capstone_project_antigravity/drone_ws/src/marl_controller/marl_controller/evaluator_node.py "$@" > /tmp/val_eval.txt 2>&1

echo "[Evaluation] Cleaning up..."
