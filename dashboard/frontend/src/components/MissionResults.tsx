            ...
            <div className="panel flex-col" style={{ flex: 1, minHeight: '250px' }}>
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                        ...
                        <span style={{ color: 'var(--accent-cyan)', fontWeight: 'bold', border: '1px solid var(--accent-cyan)', padding: '2px 8px', borderRadius: '4px' }}>N = 4</span>
                    </div>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem' }}>
                    ...
                    <tbody>
                        <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                            ...
                            <td style={{ padding: '6px 4px', color: n4Run ? 'var(--accent-cyan)' : 'var(--text-muted)' }}>
